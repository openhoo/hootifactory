...
- **Formats:** npm, Docker, OCI, PyPI, Helm, Go, Cargo, NuGet, RubyGems (9 total)
  — all verified end-to-end against Dockerized real clients (RubyGems is consumed
  via Bundler's compact index).
...
run npm, Docker, ORAS, pip/twine, Helm, Go, Cargo, dotnet and gem/bundler through pinned

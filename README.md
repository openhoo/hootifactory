...
- **Formats:** npm, Docker, OCI, PyPI, Helm, Go, Cargo, NuGet, Maven (9 total)
  — all verified end-to-end against Dockerized real clients (Maven is a
  coordinate-addressed file store with POM-driven package projection).
...
run npm, Docker, ORAS, pip/twine, Helm, Go, Cargo, dotnet and mvn through pinned

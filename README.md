...
- **Formats:** npm, Docker, OCI, PyPI, Helm, Go, Cargo, NuGet, Homebrew (9 total).
  npm, Docker, OCI, PyPI, Helm, Go, Cargo and NuGet are verified end-to-end against
...
packages/
  ...
  registry-npm/  registry-oci/  registry-pypi/  registry-go/  registry-cargo/  registry-nuget/  registry-homebrew/

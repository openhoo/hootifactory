  ...
  (t) => [
    ...
    uniqueIndex("permission_grants_user_scope_uq")
      .on(
        ...
        t.permission,
        sql`COALESCE(${t.repositoryId}, '00000000-0000-0000-0000-000000000000'::uuid)`,
        sql`COALESCE(${t.repositoryPattern}, '')`,
        sql`COALESCE(${t.packagePattern}, '')`,
        sql`COALESCE(${t.artifactPattern}, '')`,
        sql`COALESCE(${t.policy}, '')`,
        sql`COALESCE(${t.tokenTarget}, '')`,
        sql`COALESCE(${t.targetTokenId}, '00000000-0000-0000-0000-000000000000'::uuid)`,
      )

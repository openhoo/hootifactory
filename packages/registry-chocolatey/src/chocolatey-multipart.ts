...
/**
 * Minimal multipart/form-data reader. `choco push` (NuGet client) sends the
 * .nupkg as a single multipart part; we extract the first part's body. Local to
 * this package so the plugin imports only the registry SDK.
 */
